...
export function openapi(origin: string) {
  ...
  return {
    ...
    security: bearer,
    tags: [{ name: "applications" }, { name: "profile" }, { name: "account" }],
    paths: {
    ...
    components: {
      ...
      schemas: {
        ...
        KnownAnswers: { type: "object", additionalProperties: false, properties: Object.fromEntries(["firstName", "lastName", "email", "phone", "phoneCountry", "location", "gender", "linkedin", "github", "website", "heardFrom", "workAuthorizedCountries", "sponsorshipElsewhere", "needsSponsorship", "willingToRelocate", "openToOnsite", "noticePeriod", "currentCompany", "currentTitle", "yearsExperience", "salaryExpectation", "notifyEmail"].map((k) => [k, { type: "string" }])) },
        Profile: {
